...
<html lang="en">
	...
	<meta name="author" content="Mamageiremata">
	...
	<nav id="sidebar-wrapper">
		...
		<li><a id="menu-close" href="#" class="btn btn-light btn-lg pull-right toggle"><i class="fa fa-times"></i></a></li>
	...
	<section id="about">
		...
		<div class="row">
			...
			<div class="media">
				...
				<h2>Η κουζίνα μας</h2>
				<hr class="small">
				<p class="lead">Καλώς ορίσατε, στη φιλόξενη κουζίνα μας! Καθημερινά θα ετοιμάζουμε για σας μια ποικιλία μεσογειακής διατροφής με γνώριμες γεύσεις και αρώματα που θα σας ταξιδέψουν πίσω στην κουζίνα της μαμάς… ή της γιαγιάς σας! Κάθε μέρα θα μαγειρεύουμε λαδερά, όσπρια, χειροποίητες πίτες, κιμάδες και κρεατικά με μεράκι και φροντίδα, σα να τα ετοιμάζουμε για την οικογένειά μας, δηλαδή ορισμένη ποσότητα, αγνά υλικά, ανάλογα την εποχή και την έμπνευσή μας!</p>
			    </div>
			</div>
		    </div>
		</div>
		...
		<div class="row">
			...
			<div class="row">
				...
				<a class="pull-right media-middle" href="#">
				    <img data-src="img/mamageirissa1.web.png" src="img/mamageirissa2.web.png" alt="Μαμαγείρισσα... για σπιτικό φαγητό">
				</a>
				<div class="media-body">
				    <h2>Τα υλικά μας</h2>
				    <hr class="small">
				    <p class="lead">Τα υλικά μας είναι επιλεγμένα απο εμάς και με άποψη! Χρησιμοποιούμε έξτρα παρθένο ελαιόλαδο (και στα τηγανιτά), το ψωμί είναι ζυμωτό, πίτες με φύλλο «ανοιγμένο» απο τα χεράκια μας, σαλάτες φρέσκες εποχής, κρεατικά Ελληνικά νωπά, παραδοσιακά ζυμαρικά, φρεσκοαλεσμένα μπαχαρικά.</p>
				</div>
			    </div>
			</div>			
		    </div>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="portfolio-item">
					...
					<li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Μοσχάρι κοκκινιστό με συνοδεία 6,50 €</span></li>
				...
				<div class="portfolio-item">
				    <h4>Τρίτη</h4>
				    <ul class="list-unstyled">
					<li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Μοσχάρι λεμονάτο 7,00 €</span></li>
					<li><span tabindex="0" class="menu"  data-content="Παστίτσιο από αγνα υλικά">Μουσακάς 6,00 €</span></li>
					<li>Ρεβύθια 5,50 €</li>
			...
			<div class="row">
				...
				<div class="portfolio-item">
				    <h4>Τετάρτη</h4>
				    <ul class="list-unstyled">
					<li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Χοιρινό με πατάτες 6,50 €</span></li>
					<li><span tabindex="0" class="menu"  data-content="Παστίτσιο από αγνα υλικά">Παστίτσιο 6,00 €</span></li>
					<li>Γεμιστά 5,50 €</li>
				...
				<div class="portfolio-item">
				    <h4>Πέμπτη</h4>
				    <ul class="list-unstyled">
					<li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Χοιρινό ροστό με μακαρούνες 6,50 €</span></li>
					<li><span tabindex="0" class="menu"  data-content="Παστίτσιο από αγνα υλικά">Παπουτσάκια 6,00 €</span></li>
			...
			<div class="row">			    
				...
				<div class="portfolio-item">
				    <h4>Παρασκευή</h4>
				    <ul class="list-unstyled">
					<li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Μοσχάρι με μελιτζάνες 7,00 €</span></li>
					<li><span tabindex="0" class="menu"  data-content="Παστίτσιο από αγνα υλικά">Παστίτσιο 6,00 €</span></li>
				...
				<h4>Σαββάτο</h4>
				<ul class="list-unstyled">
				    <li><span tabindex="0" class="menu"  data-content="Το κοκκινιστό μας φτιάχνετε από υπέροχα υλικά">Ρολό τσαχπίνικο 6,00 €</span></li>
				    <li>Μουσακάς 6,00 €</li>
				    <li>Γεμιστά 5,50 €</li>
			...
			<a href="#contact" class="btn btn-dark">Παραγγείλτε!!</a>
		    </div>
		</div>
	    </div>
	</section>
	...
	<section class="call-to-action bg-primary" id="salads">
		...
		<div class="row">
			...
			<div class="portfolio-item">
			    <h4>Ορεκτικά</h4>
			    <ul class="list-unstyled">
				<li >Μοσχάρι κοκκινιστό με συνοδεία 6,50 €</li>
				<li>Παστίτσιο 6,00 €</li>
				<li>Γεμιστά 5,50 €</li>
				<li>Κοτόπουλο με πατάτες 6,00 €</li>
				<li>Σουτζουκάκια με συνοδεία 6,00 €</li>
		    ...
		    <div class="col-md-6 col-md-offset-3">Οι πίτες μας, αναλόγως την γέμιση τους, από 4 έως 6 ευρώ.
			Κάθε που τα υλικά θά ’ναι κατάλληλα θα παίρνει φωτιά ο πλάστης! Όλες μμμ… γεύσεις λαχταριστές!!
			Ψάρια-Θαλασσινά από 5 έως 8,50€…γιατί κάθε πράγμα στον καιρό του και ο κολιός.. τον Αύγουστο.
		    </div>
		</div>
		<a href="#contact" class="btn btn-dark">Παραγγείλτε!!</a>
	    </div>
	...
	<footer>
		...
		<div class="row">
			...
			<p class="lead">Οι Μαμαγείρισσες θα σας έχουμε συχνά και μαμαγειρέματα έκπληξη! Τηλεφωνήστε μας να μάθετε ή περάστε απ' την κουζίνα μας να δοκιμάσετε και να διαλέξετε!</p>
			...
			<ul class="list-unstyled">
			    <li><i class="fa fa-envelope-o fa-fw"></i>  <a href="mailto:info@mamageiremata.gr">info@mamageiremata.gr</a></li>
			</ul>
			<p>Κερασούντος 23, Αιγάλεω, 12244</p>
			<br>
			<ul class="list-inline">
			    <li>
				<a href="#"><i class="fa fa-facebook fa-fw fa-2x text-danger"></i></a>
			    </li>
			    <li>
				<a href="#"><i class="fa fa-twitter fa-fw fa-2x text-danger"></i></a>
			    </li>
			    <li>
				<a href="#"><i class="fa fa-google-plus fa-fw fa-2x text-danger"></i></a>
			    </li>
			</ul>
			<hr class="small">
			<p class="text-muted">Created and designed by George Mponos</p>
			<p class="text-muted">Copyright &copy; <a href="http://www.webthink.gr" target="_blank">webthink.gr</a> 2014</p>
		    </div>
		</div>
	    </div>
	</footer>
