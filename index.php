        ...
        <header id="place" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="fill" style="background-image:url('img/carousel0.jpg');"></div>
                </div>
                <div class="item">
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h4>Τρίτη</h4>
                                <ul class="list-unstyled">
                                    <li><span>Μοσχάρι λεμονάτο με συνοδεία 7,00 €</span></li>
                                    <li>
                                    ...
                                    <li><span>Κολοκύθια γεμιστά 6,00 €</span></li>
                                    <li><span>Κοτόπουλο με μπάμπιες 6,00 €</span></li>
                                    <li><span>Μελιτζάνες γιαχνί 5,00 €</span></li>
                                    <li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><span>Ιμάμ 6,00 €</span></li>
                                    <li>
                                        <span tabindex="0" class="menu" data-content="Με καρότο και κρεμμύδι">Κοτόσουπα 6,00 €</span>
                                    </li>
                                    <li><span>Κεφτέδες με συνοδεία 6,00 €</span></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h4>Παρασκευή</h4>
                                <ul class="list-unstyled">
                                    <li><span>Μοσχάρι με μελιτζάνες 7,00 €</span></li>
                                    <li>
                                    ...
                                    <li><span>Ψαρικό (ό,τι φέρει ο ψαράς)</span></li>
                                    <li>Φακές 5,00 €</li>
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><span>Κοτόπουλο με παπαρδέλες 6,00 €</span></li>
                                    <li class="hidden"><span>Σουφλέ 7,00 €</span></li>
                                    <li class="hidden"><span>Κοτόσουπα 6,00 €</span></li>
                                    <li class="hidden">Λαχανοντολμάδες 6,00 €</li>
                                    <li class="hidden"><span>Ρεβύθια 5,00 €</span></li>
                                    <li class="hidden">Σπανακόρυζο 6,00 €</li>
                                    <li class="hidden">Γιουβαρλάκια 6,00 €</li>
                                    <li class="hidden">Χταπόδι με κοφτό μακαρονάκι 8,00 €</li>
                                    <li class="hidden">
                                    ...
                                    <li class="hidden"><span>Σπανακόρυζο 6,00 €</span></li>
                                    <li class="hidden"><span>Χοιρινό πρασοσέλινο 6,50 €</span></li>
                                    <li class="hidden"><span>Λαχανοντολμάδες 6,00 €</span></li>
                                    <li class="hidden"><span>Γιουβαρλάκια 6,00 €</span></li>
                                    <li class="hidden"><span>Κοτόπουλο κοκκινιστό 6,00 €</span></li>
                                    <li class="hidden"><span>Χοιρινό γλυκόξυνο 6,50 €</span></li>
                                    <li class="hidden">Φασολάδα 5,00 €</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-10 col-lg-offset-1 text-center">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="fa fa-envelope-o fa-fw"></i>
                                <a href="mailto:mamageiremata@gmail.com">mamageiremata@gmail.com</a>
                            </li>
                        </ul>
